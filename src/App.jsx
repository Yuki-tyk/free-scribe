...
function App() {
  ...
  function handleAudioReset() { // reset the audio file and stream
    setFile(null)
    setAudioStream(null)
  }
  ...
  return (
    <div className='flex flex-col max-w-[1000px] mx-auto w-full'>
      <section className='min-h-screen flex flex-col'>
        <Header />
        {/* if output exists, then render Information.
            if loading === true, then render Transcribing.
            if isAudioAvailable === true, render FileDisplay.
